...
section.primitiveMan(:class="{ expanded }" :style="{ maxHeight: expanded ? expandedHeight + 'px' : '256px' }" ref="sectionEl")
	.wrp(ref="wrpEl")
		.image
		...
		.text
			h1 Примитивни човек
			.text-content
				p Како се појединац развија од најосновнијег, животињског, до изврсног и коначно Божанског, нема сталан увид у своје место у мрежи постојања.
				...
				p Често ружног. Често болног. Осећа свет пун бола, аномије, очајања, самоубилачког духа. Ужаса и безнађа.
				...
				p Ватра која штити, истражује и осваја. Постојана и испуњена у скромној слави несаломивог бића.
